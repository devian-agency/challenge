...
export default function cn(...classes: ClassValue[]) {
  ...
  },
  {
    title: "Day 4",
    slug: url + "day-4",
    image: imgurl + "day-4/image.png",
    "sub-title": "IOS Pointer Animation",
    description:
      "Created an iOS-style pointer that dynamically changes its size and opacity when hovering over a button. The pointer should smoothly transition between states, providing a visually appealing user experience.",
    by: {
      name: "Ayush Sharma",
      profile: imgurl + "day-4/profile.jpg",
      github: "https://github.com/ayushsharma74",
      twitter: "https://x.com/ayshtwt",
    },
...
`
  ...
  },
  {
    title: "Day 5",
    slug: url + "day-5",
    image: imgurl + "day-5/image.png",
    "sub-title": "Twitter Animated SVG Icon",
    description:
      "The Twitter animated SVG icon is a fun way to add a little animation to your website. It's a great way to add a little extra flair to your website. You can also control the animation duration and hold duration between icons switching.",
    by: {
      name: "Gajender",
      profile: imgurl + "day-5/profile.jpg",
      github: "https://github.com/Gajendrasuman",
      twitter: "https://x.com/Averrraagggeeee",
    },
    challengedOn: "07-11-2025",
    completedOn: "08-11-2025",
    code: {
