...
export function Day9() {
  return (
    <section className="max-w-7xl mx-auto h-full flex flex-wrap items-center gap-4">
          ...
          <Card className="" heading="Never miss tasks" image="/images/challenge/series/60-days/day-9/image3.avif">
