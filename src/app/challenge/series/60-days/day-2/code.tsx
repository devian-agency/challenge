...
export default function Day2Page(){
  ...
  return(
    <section className=" py-4 relative bg-background text-foreground">
...
export function Day2() {
  ...
  return (
    <div className="flex flex-col text-center gap-6 transition-colors duration-500 bg-background text-foreground">
